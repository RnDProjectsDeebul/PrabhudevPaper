...
def main():
    ...
    if args.examples:
        ...
        if use_uncertainty:
            ...
            if args.mse:
                torch.save(state, "./results/model_uncertainty_mse_Imagenette_data224.pt")
                PATH = './saved_model/saving_normal_way_model_Imagenette_data224.pt'
                torch.save(model.state_dict(), PATH)
                print("Saved: ./results/model_uncertainty_mse_Imagenette_data224.pt")
    ...
    #         if args.mse:
    #             checkpoint = torch.load("./results/model_uncertainty_mse.pt")    #model name change
